//Defining the pins where LEDS are connected 
int red_1=13; 
int orange_1=12; 
int green_1=11; 
int red_2=10; 
...
//In the loop function, we controlled the signal one 
// by one to control the flow of traffic.
void loop()   
{ 
  direction_1_green(); //all other red 
  delay(10000); 
  
  direction_1_orange(); //all other red
  delay(5000);
  
  direction_2_green(); //all other red
  delay(10000); 
  
  direction_2_orange(); //all other red
  delay(5000); 
  
  direction_3_green(); //all other red 
  delay(10000); 
  
  direction_3_orange(); //all other red
  delay(5000);
  
  direction_4_green(); //all other red
  delay(10000); 
  
  direction_4_orange(); //all other red
  delay(5000); 
}
